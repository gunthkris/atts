...
while (True):
    ...
    (ldX, ldY, lpts, ldirection) = trackedObjectXYcoord (leftFrame, leftcnts, ldX, ldY, lpts, ldirection)
    # show the movement deltas and the direction of movement on the frame
    cv2.putText(leftFrame, ldirection, (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
	0.65, (0, 0, 255), 3)
    cv2.putText(leftFrame, "dx: {}, dy: {}".format(ldX, ldY),
	(10, leftFrame.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX,
	0.65, (0, 0, 255), 1)
	
    # Call function for right frame
    (rdX, rdY, rpts, rdirection) = trackedObjectXYcoord (rightFrame, rightcnts, rdX, rdY, rpts, rdirection)
    # show the movement deltas and the direction of movement on the frame
    cv2.putText(rightFrame, rdirection, (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
	0.65, (0, 0, 255), 3)
    cv2.putText(rightFrame, "dx: {}, dy: {}".format(rdX, rdY),
