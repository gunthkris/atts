...
def dispSliders():
    ...
    wsize_ = tk.Scale(root, from_=3, to=20, resolution=1, orient=tk.HORIZONTAL, label="Window Size")
    wsize_.set(wsize)
    minD_ = tk.Scale(root, from_=-60, to=100, resolution=1, orient=tk.HORIZONTAL, label="Min Disparity")
    minD_.set(minD)
    numD_ = tk.Scale(root, from_=100, to=320, resolution=16, orient=tk.HORIZONTAL, label="Num Disparity")
    numD_.set(numD)
    P1__ = tk.Scale(root, from_=3, to=12, resolution=1, orient=tk.HORIZONTAL, label="P1")
    P1__.set(P1_)
    P2__ = tk.Scale(root, from_=16, to=72, resolution=1, orient=tk.HORIZONTAL, label="P2")
    P2__.set(P2_)
    d12Maxd_ = tk.Scale(root, from_=2, to=24, resolution=1, orient=tk.HORIZONTAL, label="disp12MaxDiff")
    d12Maxd_.set(d12Maxd)
    uniqR_ = tk.Scale(root, from_=2, to=60, resolution=1, orient=tk.HORIZONTAL, label="Uniqueness Ratio")
    uniqR_.set(uniqR)
    speckWsize_ = tk.Scale(root, from_=1, to=256, resolution=1, orient=tk.HORIZONTAL, label="Speckle Window Size")
    speckWsize_.set(speckWsize)
    speckR_ = tk.Scale(root, from_=1, to=128, resolution=1, orient=tk.HORIZONTAL, label="Speckle Range")
    speckR_.set(speckR)
    preFC_ = tk.Scale(root, from_=1, to=128, resolution=1, orient=tk.HORIZONTAL, label="Pre Filter Cap")
    preFC_.set(preFC)
    wsize_.pack()
    minD_.pack()
    numD_.pack()
...
def Threshold_Demo(val,dst,src):
    #0: Binary
    #1: Binary Inverted
